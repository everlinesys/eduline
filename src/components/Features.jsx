    ...
    <section className="relative py-28 bg-white overflow-hidden" id="Solutions">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="mb-32 max-w-3xl">
          <div className="inline-block px-4 py-1.5 mb-6 text-sm font-bold tracking-widest text-emerald-200 uppercase bg-emerald-800/40 rounded-full backdrop-blur-md border border-emerald-400/20">
          ...
          {features.map((item, idx) => (
            ...
            >
              ...
              <div className="flex-1 space-y-8">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-emerald-50 shadow-xl shadow-emerald-500/10 rounded-[2rem] border border-emerald-100">
                  {item.icon}
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 p-5 bg-emerald-50/50 rounded-2xl border border-emerald-100/50">
                    ...
                    <p className="text-sm font-bold text-emerald-700 uppercase tracking-wide leading-snug">
                      {item.subText}
                    </p>
                  </div>
                </div>
              ...
              <div className="flex-1 w-full">
                <div className="relative group">
                  <div className="absolute -inset-8 bg-emerald-500/10 rounded-[4rem] blur-3xl opacity-0 group-hover:opacity-100 transition duration-1000"></div>
