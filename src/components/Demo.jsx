...
import { ExternalLink, Monitor, Globe, Sparkles } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-20 flex flex-col items-center">
            <div className="p-6 bg-white rounded-3xl border border-slate-200 shadow-xl flex flex-col md:flex-row items-center gap-6">
                ...
                <button className="px-8 py-3 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 transition-all flex items-center gap-2">
